...
urlpatterns = [
    ...
    path("stats/genre-breakdown/", views.stats_genre_breakdown, name="stats_genre_breakdown"),
    ...
    path(
        "profile/<int:profile_id>/stats/genre-breakdown/",
        views.stats_genre_breakdown,
        name="member_stats_genre_breakdown",
    ),
    path("activity/", views.activity, name="activity"),
    path("activity/leaderboard/", views.activity_leaderboard, name="activity_leaderboard"),
    ...
    path("settings/api-tokens/create/", views.create_api_token, name="create_api_token"),
    path("settings/api-tokens/<int:pk>/regenerate/", views.regenerate_api_token, name="regenerate_api_token"),
    path("settings/api-tokens/<int:pk>/delete/", views.delete_api_token, name="delete_api_token"),
    ...
    path("settings/service-api-keys/create/", views.create_service_api_key, name="create_service_api_key"),
    path("settings/service-api-keys/<int:pk>/revoke/", views.revoke_service_api_key, name="revoke_service_api_key"),
    path("admin-dashboard/manage-wrapped/", views.manage_wrapped, name="manage_wrapped"),
